  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        {
          path: "/admin/class-notices",
          labelZh: "全班通知",
          labelEn: "Class notices",
          icon: MessageSquare,
        },
      ],
    },
    {
      ...
      titleEn: "Content",
      items: [
        // /admin/cms/course-intro is intentionally hidden (ADR-004 amendment A10):
        // the feature was never built — the course_intros table does not exist and
