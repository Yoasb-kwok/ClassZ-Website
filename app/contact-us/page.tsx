      ...
      <div className="relative">
        ...
        >
          ...
          {isPriority ? (
            ...
            <>
              <option value={t("contactPage.form.category.optionGeneral")}>{t("contactPage.form.category.optionGeneral")}</option>
              <option value={t("contactPage.form.category.optionPartnership")}>{t("contactPage.form.category.optionPartnership")}</option>
              <option value={t("contactPage.form.category.optionSupport")}>{t("contactPage.form.category.optionSupport")}</option>
              <option value={t("contactPage.form.category.optionFeedback")}>{t("contactPage.form.category.optionFeedback")}</option>
            </>
          )}
        </select>
