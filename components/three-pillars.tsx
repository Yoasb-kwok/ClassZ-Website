        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-3xl p-8 shadow-sm hover:shadow-md transition-shadow">
            <div className="mb-6">
              ...
              <p className="text-slate-600">Discover top centres by program type and category.</p>
            </div>
            <div className="bg-slate-100 rounded-2xl p-4 aspect-[4/5] relative overflow-hidden group">
              {/* Mockup UI */}
              <div className="absolute inset-x-4 top-4 bottom-0 bg-white rounded-t-2xl shadow-lg p-4 border border-slate-100">
          ...
          <div className="bg-white rounded-3xl p-8 shadow-sm hover:shadow-md transition-shadow">
            <div className="mb-6">
              ...
              <p className="text-slate-600">Enroll instantly with class schedules and multiple payments methods.</p>
            </div>
            <div className="bg-slate-100 rounded-2xl p-4 aspect-[4/5] relative overflow-hidden">
              ...
              <div className="absolute inset-x-4 top-4 bottom-0 bg-white rounded-t-2xl shadow-lg p-4 border border-slate-100">
                ...
                <div className="space-y-3">
                  <div className="p-3 rounded-lg border border-slate-100 flex justify-between items-center">
                    <div className="h-2 w-20 bg-slate-200 rounded" />
          ...
          <div className="bg-white rounded-3xl p-8 shadow-sm hover:shadow-md transition-shadow">
            <div className="mb-6">
              ...
              <p className="text-slate-600">Stay organized with performance feedback, and growth updates.</p>
            </div>
            <div className="bg-slate-100 rounded-2xl p-4 aspect-[4/5] relative overflow-hidden">
              {/* Mockup UI */}
              <div className="absolute inset-x-4 top-4 bottom-0 bg-white rounded-t-2xl shadow-lg p-4 border border-slate-100">
