  ...
  return (
    <section className="py-24 bg-white">
      <div className="container mx-auto px-4">
        <div className="mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-4">A New Standard in Learning.</h2>
          <p className="text-xl text-slate-500">Why families choose Classz?</p>
        </div>

        <div className="grid md:grid-cols-3 gap-12 mb-16">
          <div className="space-y-4">
            <span className="text-6xl font-light text-slate-200">01</span>
            <h3 className="text-xl font-bold text-slate-900">Targeted Learning</h3>
          ...
          <div className="space-y-4">
            ...
            <h3 className="text-xl font-bold text-slate-900">Inclusive Community</h3>
            <p className="text-slate-600 leading-relaxed">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-2">
              <h3 className="text-xl font-bold text-slate-900">Holistic Support</h3>
