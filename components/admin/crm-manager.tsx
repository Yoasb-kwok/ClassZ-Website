...
> = {
  new: {
    bar: "bg-crm-magenta",
    tint: "bg-[color-mix(in_srgb,var(--crm-magenta)_8%,white)] border-[color-mix(in_srgb,var(--crm-magenta)_28%,white)]",
    chip: "text-crm-magenta",
    label: "text-crm-magenta",
  },
  contacted: {
    bar: "bg-crm-orange",
    tint: "bg-[color-mix(in_srgb,var(--crm-orange)_8%,white)] border-[color-mix(in_srgb,var(--crm-orange)_28%,white)]",
    chip: "text-crm-orange",
    label: "text-crm-orange",
  },
  qualified: {
    bar: "bg-crm-teal",
    tint: "bg-[color-mix(in_srgb,var(--crm-teal)_8%,white)] border-[color-mix(in_srgb,var(--crm-teal)_28%,white)]",
    chip: "text-crm-teal",
    label: "text-crm-teal",
  },
  trial: {
    bar: "bg-crm-slate",
    tint: "bg-[color-mix(in_srgb,var(--crm-slate)_7%,white)] border-[color-mix(in_srgb,var(--crm-slate)_22%,white)]",
    chip: "text-crm-slate",
    label: "text-crm-slate",
  },
  won: {
    bar: "bg-crm-teal",
    tint: "bg-[color-mix(in_srgb,var(--crm-teal)_12%,white)] border-[color-mix(in_srgb,var(--crm-teal)_35%,white)]",
    chip: "text-crm-teal",
    label: "text-crm-teal",
  },
  lost: {
    bar: "bg-crm-coral",
    tint: "bg-[color-mix(in_srgb,var(--crm-coral)_8%,white)] border-[color-mix(in_srgb,var(--crm-coral)_28%,white)]",
    chip: "text-crm-coral",
    label: "text-crm-coral",
  },
}
