    ...
    <section className="py-24 overflow-hidden">
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row items-center gap-10 md:gap-12 lg:gap-16 xl:gap-20">
          {/* Left Collage */}
          <div className="hidden md:grid lg:hidden grid-cols-2 gap-4 w-full max-w-2xl opacity-80">
            <img
          ...
          <div className="hidden lg:grid grid-cols-2 gap-4 w-full max-w-[20rem] xl:max-w-[24rem] opacity-80">
          ...
          <div className="flex-1 text-center max-w-xl mx-auto">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 text-brand-slate">Discover Exceptional Classes.</h2>
            <p className="text-base md:text-lg text-brand-slate/80 mb-8 md:mb-10 leading-relaxed">
